...
class Site extends Controller
{
	...
	{
		parent::Controller();
		$this->load->model( 'setting/Site_model', 'model' );
	...
	public function index()
	{
		...
		$cols = array(
			...
			'site_feed' => array( 'Feed', 250, TRUE, 'left', 0 ),
			'site_name' => array( 'Name', 200, TRUE, 'left', 0 ),
			'site_query' => array( 'Fetch', 40, TRUE, 'center', 0 ),
			'site_lastquery' => array( 'Last', 150, TRUE, 'left', 0 ),
			'site_status' => array( 'Status', 150, TRUE, 'left', 0 )
